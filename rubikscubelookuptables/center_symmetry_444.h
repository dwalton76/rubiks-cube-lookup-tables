...
/*
 * Coordinates for centers_444 order.  The signed permutation matrices form
 * the full octahedral group: 24 rotations and 24 reflections.
 */
...
{
    /* Sorted multiset symbols are F, L, U for z, x, y axes. */
