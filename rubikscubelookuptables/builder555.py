...
class Build555XCenterStageOnePhase(BFS):
    ...
    def __init__(self):
        BFS.__init__(
            self,
            "5x5x5-x-center-stage-one-phase",
            (),
            "5x5x5",
            "lookup-table-5x5x5-step15-x-centers-stage-one-phase.txt",
            False,  # store_as_hex
            # starting cubes
            (
                (
...
class Build555TCenterStageOnePhase(BFS):
    ...
    def __init__(self):
        BFS.__init__(
            self,
            "5x5x5-T-center-stage-one-phase",
            (),
            "5x5x5",
            "lookup-table-5x5x5-step16-t-centers-stage-one-phase.txt",
            False,  # store_as_hex
            # starting cubes
            (
                (
...
class Build555CenterStageOnePhase(BFS):
    ...
    def __init__(self):
        BFS.__init__(
            ...
            (),
            "5x5x5",
            "lookup-table-5x5x5-step17-centers-stage-one-phase.txt",
            False,  # store_as_hex
            # starting cubes
            (
                (
