...
void
rotate_222(char *cube, char *cube_tmp, int array_size, char *step)
{
    /* This was contructed using 'solver.py --rotate-printer' */
...
void
rotate_333(char *cube, char *cube_tmp, int array_size, char *step)
{
    /* This was contructed using 'solver.py --rotate-printer' */
    memcpy(cube_tmp, cube, sizeof(char) * array_size);
...
void
rotate_444(char *cube, char *cube_tmp, int array_size, char *step)
{
    /* This was contructed using 'solver.py --rotate-printer' */
    memcpy(cube_tmp, cube, sizeof(char) * array_size);
...
void
rotate_555(char *cube, char *cube_tmp, int array_size, char *step)
{
    /* This was contructed using 'solver.py --rotate-printer' */
    memcpy(cube_tmp, cube, sizeof(char) * array_size);
...
void
rotate_666(char *cube, char *cube_tmp, int array_size, char *step)
{
    /* This was contructed using 'solver.py --rotate-printer' */
    memcpy(cube_tmp, cube, sizeof(char) * array_size);
...
void
rotate_777(char *cube, char *cube_tmp, int array_size, char *step)
{
    /* This was contructed using 'solver.py --rotate-printer' */
    memcpy(cube_tmp, cube, sizeof(char) * array_size);
